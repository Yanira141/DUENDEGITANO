              ...
              <div className="col-lg-7">
                ...
                <div className="our-story">
                  <p className="pt-5">
                    ...
                    estuvo presentandose en castings de grupos de campeonato y
                    con su grupo de Hip-Hop.{" "}
                  </p>
                  <p>
                    También ha bailado en varios campeonatos tanto a nivel
                    nacional como internacional, ganando varios premios.{" "}
                  </p>
                  <p>
                    Más adelante empezo con su formación de guitarra en el
                    conservatorio, pero su familia le animo a que se apuntara en
                  ...
                  <p>
                    ...
                    poco recibio un premio con mención al mejor bailarín, junto
                    a una beca para irse a Italia a estudiar en verano.
                  </p>
