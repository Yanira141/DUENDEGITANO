...
<div className="container pt-5">
		<div className="row row-striped">
			<div className="col-2 text-right">
				<h1 className="display-4"><span className=" badge-secondary">{curso.fecha}</span></h1>
				
			</div>
			<div className="col-10">
				<h3 className="text-uppercase"><strong>{curso.nombre}</strong></h3>
				<ul className="list-inline">
				
					<li className="list-inline-item"><i className="bi bi-clock"></i> {curso.hora}</li>
					<li className="list-inline-item"><i class="bi bi-person-bounding-box"></i> {curso.profesor}</li>
